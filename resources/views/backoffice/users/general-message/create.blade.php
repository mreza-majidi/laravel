                    ...
                    <div class="col-lg-8 offset-2">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">{{__('Create Announcement')}}</h3>
                            </div>
                            <!--begin::Form-->
                            <form class="form" method="post"
                                  action="{{route('backoffice.announcement.store')}}">
                                @csrf
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-8 ml-lg-auto ">
                                            <button type="submit"
                                                    class="btn btn-light-dark font-weight-bold h-40px font-size-link w-100px">{{__('Submit')}}</button>
                                            <button type="reset"
