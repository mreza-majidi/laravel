                    ...
                    <div class="col-lg-8 offset-2">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">ویرایش پیام خصوصی</h3>
                            </div>
                            <!--begin::Form-->
                            <form class="form" method="post"
                                  action="{{route('backoffice.private_message.update',$message)}}">
                                @csrf
                                @method('patch')
                                <div class="form-group row pt-10 mb-4">
                                    ...
                                    <div class="col-lg-6 col-md-9 col-sm-12">
                                        <select class="form-control select2" type="text" id="kt_select2_1" name="user">
                                            @foreach($users as $user)
                                                <option value="{{$user->uuid}}" @if($user->uuid == $message->user->uuid) selected @endif>{{$user->getFullName()}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row pt-3">
                                    ...
                                    <div class="col-lg-6 col-md-9 col-sm-12">
                                        <input name="title" type="text"
                                               ...
                                               value="{{$message->title}}" placeholder="موضوع">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-6 col-md-9 col-sm-12">
                                                <textarea name="text" type="text"
                                                          class="form-control form-control-lg form-control-solid"
                                                          placeholder="متن">{{$message->text}}</textarea>
                                    </div>
                                </div>
