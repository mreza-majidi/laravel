        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Button-->
                    <a href="javascript:history.back();" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
                    <!--end::Button-->
                    <!--begin::Dropdown-->
                    <div class="btn-group ml-2">
                        <button type="button" onclick="$('#kt_form').submit();" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">
                            Save Changes
                        </button>
                        <button type="button"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="image-input image-input-empty image-input-outline"
                                                         ...
                                                         style="background-image: url({{asset('assets/user/media/users/blank.png')}})">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <div class="form-text text-muted">For extra security, this requires
                                                        you
                                                        to confirm your email or phone number when you reset your
                                                        password.
                                                    ...
                                                    <div class="col-9">
                                                        <div
                                                            ...
                                                            <div class="alert-text font-weight-bold">Configure user
                                                                ...
                                                                going
                                                                to expire, or they might inadvertently get locked out of
                                                                the
                                                                system!
                                                            </div>
