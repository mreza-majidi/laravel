...
//---
        ...
        curl_setopt($this->m_curl, CURLOPT_PROXY_SSL_VERIFYPEER, 0); // comment out this line if you use self-signed certificates
        curl_setopt($this->m_curl, CURLOPT_MAXCONNECTS, 1);    // one connection is used
        curl_setopt($this->m_curl, CURLOPT_HTTPHEADER, ['Connection: Keep-Alive']);
//---
