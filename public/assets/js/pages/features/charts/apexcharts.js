...
var KTApexChartsDemo = function () {
	...
	var _demo1 = function () {
		...
		var options = {
			series: [{
				name: "واریز",
				data: Object.values(chartDataDeposit)
			}],
			chart: {
				height: 350,
				type: 'line',
			...
			xaxis: {
				categories: Object.keys(chartDataDeposit),
			},
			colors: ['#1e1e2d']
		};
	...
	var _demo2 = function () {
        ...
        var options = {
            series: [{
                name: "برداشت",
                data: Object.values(chartDataWithdraw)
            }],
            chart: {
                height: 350,
                type: 'line',
            ...
            xaxis: {
                categories: Object.keys(chartDataWithdraw),
            },
            colors: ['#e5c45d']
        };
